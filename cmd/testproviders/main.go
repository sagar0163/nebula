...
var providers = []providerSpec{
	{
		...
		primary:    []string{"llama-3.1-8b-instant", "llama-3.3-70b-versatile"},
		alts:       []string{"llama-3.2-3b-preview", "gemma2-9b-it", "mixtral-8x7b-32768"},
	},
	{
		name:       "MISTRAL",
		keyringKey: "mistral_api_key",
		baseURL:    "https://api.mistral.ai/v1",
		primary:    []string{"mistral-small-latest", "mistral-medium-latest"},
		alts:       []string{"open-mistral-7b", "open-mixtral-8x7b", "mistral-large-latest"},
	},
	{
		name:       "NVIDIA",
